...
?>
    ...
    <section id="content_wrapper">
      ...
      <div class="panel-heading">
        <span class="panel-title"><b style="font-size:1.4em;">Delivery Report - <?php echo $_GET['n']; ?> - All Time</b>
  ...
  if(file_exists($logsdir.'bleedlogs/'.$_GET['cid']))
  {
    ...
    foreach($files as $f)
    {
      ...
      echo '<option value="'.$name.'">'.$name.':00</option>';
    }
  }
  echo '</select></form></li>';
                      ...
                      <table class="table table-striped table-hover" style="overflow:hidden;" id="datatable" cellspacing="0" width="100%">
                        <thead>
                          <tr>
                            ...
                            <th data-toggle="tooltip" data-placement="bottom" title="<b>Percentage Human</b><br><i>The percentage of impressions that actually arrived and passed the human verification test.</i>" data-html="true">Human</th>
                          </tr>
                        </thead>
                        <tfoot>
                            <tr>
    ...
    <?php
        ...
        foreach($wins as $w)
        {
            ...
            echo '<tr>';
            echo '<td class="min"><b>'.substr(str_replace($_GET['cid'].'-dbl-', '', $w), 0, 32).'</b></td>';
            ...
            echo '<td class="min">'.number_format(divide(100, $v1)*$v2, 2).'%</td>';
            echo '</tr>';
	...
	?>
                      ...
                      <b>Total Human: </b><?php echo number_format($th); ?><br>
                      <b>Total Human Percent: </b><?php echo number_format(divide(100, $tw)*$th); ?>%<br><br>
                      ...
                      <b>Over Sent: </b><?php echo number_format($os); ?><br>
                      </font></center>
